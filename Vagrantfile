...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "udacityvm" do |udacityvm|          
    udacityvm.vm.hostname      = "udacityvm"
    
    udacityvm.vm.provision "ansible" do |ansible|
      ansible.verbose                 = "vv"                      
      ansible.playbook                = "bootstrap/main-playbook.yml"
  end
